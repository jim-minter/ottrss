...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE feeds (id INTEGER PRIMARY KEY, title TEXT COLLATE NOCASE, syncmode INTEGER NOT NULL DEFAULT 0, articles INTEGER NOT NULL DEFAULT 0, unread INTEGER NOT NULL DEFAULT 0, synctoken INTEGER NOT NULL)");
